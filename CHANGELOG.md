...
- macOS release/profile configuration and the Intel CI build host now
  explicitly build both `x86_64` and `arm64`; the packaged executable and
  every embedded Mach-O remain verifier-gated.
